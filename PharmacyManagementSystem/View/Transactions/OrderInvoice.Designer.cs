namespace PharmacyManagementSystem.View.Transactions
{
    partial class OrderInvoice
    {
        ...
        private void InitializeComponent()
        {
            ...
            gridView.Columns.AddRange(new DataGridViewColumn[] { OrderID, DateOrder, Customer, Employee, TotalAmount });
            ...
            OrderID.HeaderText = "Mã hóa đơn";
            OrderID.MinimumWidth = 6;
            OrderID.Name = "OrderID";
            OrderID.SortMode = DataGridViewColumnSortMode.Programmatic;
            // 
            // DateOrder
            // 
